          ...
          <div class=" navbar-collapse " id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              @if (Route::has('login'))
                  @auth
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('ShowCart') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Cart</a>
                </li>
                  {{-- <li>
                    <x-app-layout>
                    </x-app-layout>
